                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <ul class="p-0 m-0">
                                ...
                                <li class="d-flex mb-4 pb-1">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/watch.png') }}" alt="oneplus" />
                                    </div>
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex mb-4 pb-1">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/surface.png') }}" alt="oneplus" />
                                    </div>
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/earphone.png') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <ul class="p-0 m-0">
                                <li class="d-flex mb-4 pb-1">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/laptop-secondary.png') }}"
                                ...
                                <li class="d-flex mb-4 pb-1">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/computer.png') }}" alt="Apple"
                                            class="rounded" />
                                    </div>
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex mb-4 pb-1">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/watch.png') }}" alt="Smart Watch"
                                            class="rounded" />
                                    </div>
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex mb-4 pb-1">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/oneplus-success.png') }}"
                                ...
                                <li class="d-flex">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ url('assets/img/icons/unicons/pixel.png') }}" alt="Pixel 4a"
                                            class="rounded" />
                                    </div>
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar me-2">
                                            <img src="{{ url('assets/img/avatars/17.png') }}" alt="Avatar"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar me-2">
                                            <img src="{{ url('assets/img/avatars/8.png') }}" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="d-flex flex-column">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar me-2">
                                            <img src="{{ url('assets/img/avatars/2.png') }}" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="d-flex flex-column">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar me-2">
                                            <img src="{{ url('assets/img/avatars/11.png') }}" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="d-flex flex-column">
                    ...
                    <table class="invoice-list-table table border-top">
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                    ...
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar-wrapper">
                                            <div class="avatar avatar-sm me-2">
                                                <img src="{{ url('assets/img/avatars/7.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                        </div>
                                        <div class="d-flex flex-column">
                                ...
                                <td>
                                    <img src="{{ url('assets/img/icons/payments/master-light.png') }}" class="img-fluid"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar-wrapper">
                                            <div class="avatar avatar-sm me-2">
                                                <img src="{{ url('assets/img/avatars/20.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                        </div>
                                        <div class="d-flex flex-column">
                                ...
                                <td>
                                    <img src="{{ url('assets/img/icons/payments/visa-light.png') }}" class="img-fluid"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar-wrapper">
                                            <div class="avatar avatar-sm me-2">
                                                <img src="{{ url('assets/img/avatars/9.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                        </div>
                                        <div class="d-flex flex-column">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="avatar-wrapper">
                                            <div class="avatar avatar-sm me-2">
                                                <img src="{{ url('assets/img/avatars/14.png') }}" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                        </div>
                                        <div class="d-flex flex-column">
                                ...
                                <td><span class="badge bg-label-success"> Paid </span></td>
                                <td>
                                    <img src="{{ url('assets/img/icons/payments/paypal-light.png') }}" class="img-fluid"
